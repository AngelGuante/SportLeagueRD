...
namespace SportLeagueRD.View{
	...
	public partial class view_rankingJugador : ContentPage{
        #region VARIABLES
        private viewmodel_jugadores viewmodel = null;
        #endregion

        #region CONSTRUCTOR
        public view_rankingJugador(){
            InitializeComponent();

            viewmodel = new viewmodel_jugadores("1");
